// src/pages/CustomerCategoriesPage.jsx
...
import CustomerCategoryForm from "../modals/CustomerCategoryForm";
...
export default function CustomerCategoriesPage() {
  ...
  const load = async () => {
    ...
    setError(null);
    try {
      const res = await fetchCustomerCategories();
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      await deleteCustomerCategory(deleteModal.category.id);
      await load();
      closeDeleteModal();
    } catch (err) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div>
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Organize your clients by industry, partnership type, or region.
          </p>
        </div>
      ...
      <DeleteConfirmModal
        ...
        message="Customers in this category will become uncategorized. This action cannot be undone."
      />
    </div>
  );
}
