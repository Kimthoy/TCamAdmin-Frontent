      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="w-72 px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-emerald-500/40"
          />
          ...
          <button
            ...
            className="group px-5 hover:cursor-pointer py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl shadow-lg hover:shadow-xl transition flex items-center gap-2"
          >
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end gap-3">
                            <button
                              ...
                              className="p-3 rounded-xl hover:cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400"
                            >
                            ...
                            <button
                              ...
                              className="p-3 rounded-xl hover:cursor-pointer hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600"
                            >
            ...
            <div className="px-6 py-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between dark:text-slate-200">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={page <= 1}
                  className="px-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-slate-700 hover:cursor-pointer disabled:opacity-60"
                >
                  Prev
                </button>
