...
export default function CustomerForm({
  ...
  // Same animations as all other forms
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="customerform-title"
          >
              ...
              <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Leading provider of enterprise solutions..."
                ...
                {/* Logo Upload - Same gorgeous style */}
                <div>
